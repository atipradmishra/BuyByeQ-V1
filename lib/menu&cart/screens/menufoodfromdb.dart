...
import 'cartuifromdb.dart';

class ShoppingMenuDB extends StatefulWidget {
  ShoppingMenuDB({Key? key,required this.id}) : super(key: key);
String id;
  @override
  State<ShoppingMenuDB> createState() => _ShoppingMenuDBState();
}

class _ShoppingMenuDBState extends State<ShoppingMenuDB> {
  int _presscount = 0;
  void _onPressed() {
    setState(() {
      _presscount++;
    ...
    child:Scaffold(
        ...
        bottomNavigationBar: InkWell(onTap: () {
          ...
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => CartScreenDB(id: orderid,)));
